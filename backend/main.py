...
def rebalancear_carteira(req: RebalanceamentoRequest):
    ...
    # 2. Motor de Cálculo (Pesos iguais de diversificação)
        ...
        if d["falta"] > 0 and dinheiro_disponivel >= d["preco"]:
            ...
            if qtd_comprar > 0:
                ...
                compras.append({
                    ...
                    "preco_estimado": d["preco"],
                    "total": custo
                })

    return {
        "compras": compras,
        "sobra": dinheiro_disponivel
    }
